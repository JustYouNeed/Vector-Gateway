...
//SDIO相关参数定义
#define NULL 0
#define SDIO_STATIC_FLAG                ((uint32_t)0x000005FF)
...
//SD_Error bsp_sd_ReadBlocks_DMA(uint32_t *buff, uint16_t sector, uint32_t blocksize, uint32_t cnt);
//SD_Error bsp_sd_WriteBlocks_DMA(uint32_t *buff, uint16_t sector, uint32_t blocksize, uint32_t cnt);
# endif
