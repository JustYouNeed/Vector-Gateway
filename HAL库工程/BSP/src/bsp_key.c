...
void bsp_key_GPIOConfig(void)
{
	...
	HAL_GPIO_WritePin(KEY_UP_PORT, KEY_UP_PIN, GPIO_PIN_SET);
	
	GPIO_InitStructure.Pin = KEY_OK_PIN;
	HAL_GPIO_Init(KEY_OK_PORT, &GPIO_InitStructure);	
	HAL_GPIO_WritePin(KEY_OK_PORT, KEY_OK_PIN, GPIO_PIN_SET);
	
	GPIO_InitStructure.Pin = KEY_DOWN_PIN;
	HAL_GPIO_Init(KEY_DOWN_PORT, &GPIO_InitStructure);	
	HAL_GPIO_WritePin(KEY_DOWN_PORT, KEY_DOWN_PIN, GPIO_PIN_SET);
}
