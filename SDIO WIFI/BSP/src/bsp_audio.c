...
void bsp_audio_IICConfig(void)
{
	...
	bsp_GPIOClcokCmd(AUDIO_SDA_PORT);
	bsp_GPIOClcokCmd(AUDIO_SCL_PORT);
	
	GPIO_InitStructure.GPIO_Pin = AUDIO_SDA_PIN;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;//复用功能
  GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;//推挽 
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//100MHz
  GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;//上拉
  GPIO_Init(AUDIO_SDA_PORT, &GPIO_InitStructure);//初始化
	
	GPIO_InitStructure.GPIO_Pin = AUDIO_SCL_PIN;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;//复用功能
  GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;//推挽 
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//100MHz
  GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;//上拉
  GPIO_Init(AUDIO_SCL_PORT, &GPIO_InitStructure);//初始化
